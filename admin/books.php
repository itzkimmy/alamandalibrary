  ...
  document.body.style.backgroundColor = "white";
	...
	<div class="srch">
		...
		<form class="navbar-form" method="post" name="form1">
				...
				<input class="form-control" type="text" name="bid" placeholder="Enter Book ISBN" required="">
...
if (isset($_POST['submit1'])) {
  if (isset($_SESSION['login_user'])) {
      // Get the book's image filename from the database
      $result = mysqli_query($db, "SELECT image FROM books WHERE bid = '$_POST[bid]'");

      if ($result) {
          $row = mysqli_fetch_assoc($result);
          $imageFilename = $row['image'];

          // Delete the book's image file from the 'bookimage' folder
